    ...
    public class SocialController : ApiController
    {
        ...
        public HttpResponseMessage Get(string page)
        {
            ...
            if (page.ToLower() == "cbindex")
            {
                ...
                images.Add("https://carriebrown.com/wp-content/uploads/2018/12/carrieblog.jpg");
                images.Add("https://carriebrown.com/wp-content/uploads/pp/images/logo_1541945843.png");
                images.Add("https://richhopkins.me/images/CBGroup.jpg");
            }
